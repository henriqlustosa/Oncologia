...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <style type="text/css">
        ...
        .button-wrapper {
            ...
            flex: 1 0 20%; /* Four buttons per row */
            display: flex;
 ...
 Styles for the modal content itself*/
    ...
    <div class="container">
        <div class="x_panel">
            ...
            <div class="row">
                <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                    <asp:Button ID="btnGravarCopia" runat="server" Text="Gravar" class="btn btn-primary" OnClick="btnGravarCopia_Click" />
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 form-group button-container">
                    <div class="button-wrapper">
                        <asp:Button ID="btnAtualizar" runat="server" Text="Atualizar" class="btn btn-primary atualizar" OnClick="btnGravar_Click" data-toggle="modal" />
                    </div>
                    <div class="button-wrapper">
                    ...
                    <div class="button-wrapper">
                        <asp:LinkButton ID="btnCancelar" runat="server" CssClass="btn btn-danger cancelar" OnClick="btnCancelar_Click">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:GridView ID="GridViewPreQuimio" runat="server" AutoGenerateColumns="False" DataKeyNames="cod_CalculoDosagemPreQuimio"
                                CellPadding="4" ForeColor="#333333" GridLines="Horizontal" BorderColor="#e0ddd1"
                                Width="100%" OnRowCommand="gridViewPreQuimio_RowCommand">
                            ...
                            <asp:GridView ID="GridViewProtocolo" runat="server" AutoGenerateColumns="False" DataKeyNames="cod_CalculoDosagem"
                                CellPadding="4" ForeColor="#333333" GridLines="Horizontal" BorderColor="#e0ddd1"
                                Width="100%" OnRowCommand="gridViewProtocolo_RowCommand">
